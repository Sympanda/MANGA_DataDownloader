"""CLI: export galaxy-level Pipe3D global BPT / star-forming flags."""
...
from manga_prep.targets.global_flags import discover_local_plateifus, make_global_flag_rows
...
def parse_args(argv: list[str] | None = None):
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Path to SDSS17Pipe3D_v3_1_1.fits (or equivalent integrated Pipe3D catalog).",
    )
    parser.add_argument(
        "--out",
        type=Path,
        default=Path("manga_sdss_fits/pipe3d_global_flags.csv"),
    )
    parser.add_argument(
        "--data-root",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.3,
        help="Maximum global log-ratio error for global_bpt_sf_strict. Default: 0.3 dex.",
    )
    parser.add_argument(
        "--min-ha-ew-emission",
        type=float,
        default=3.0,
        help="Minimum positive-emission Halpha EW for global_sf_ew_strict. Default: 3 Angstrom.",
    )
    parser.add_argument(
        "--min-ha-ew-snr",
        type=float,
        default=3.0,
        help="Minimum positive-emission Halpha EW S/N for global_sf_ew_strict. Default: 3.",
    )
